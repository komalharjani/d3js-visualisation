...
d3.csv(dataPath)
    .then(function (data) {
        ...
        //based on one slider --> make based on submit button
        ...
        //slider.onchange = function () {
            ...
            let min = document.getElementById("minYear").value; //get from sliders
        ...
        legend = svg.selectAll(".legend")
            .data(currData[0].values.map(function (d) { return d.key.energy; }))
            .enter().append("g")
            .attr("class", "legend")
