...
d3.csv(dataPath)
        .then(function (data) {
                ...
                for (let i = 0; i < data.length; i++) {
                        if (data[i].region == "west" && data[i].year == 1990 && data[i].type == "Total Electric Power Industry") {
                                randomData.push({
                ...
                for (let i = 0; i < 5; i++) { //for each energySrc
                        sortedData[0].push("northeast")
                        sortedData[1].push("midwest")
                        sortedData[2].push("southeast")
                        sortedData[3].push("west")
                        sortedData[4].push("southwest")
