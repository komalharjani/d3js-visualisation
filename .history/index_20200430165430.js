...
d3.csv(dataPath)
        .then(function (data) {
                ...
                for (let i = 0; i < 5; i++) { //for each energySrc
                        // sortedData1990[0].push("northeast")
                        // sortedData1990[1].push("midwest")
                        // sortedData1990[2].push("southeast")
                        // sortedData1990[3].push("west")
                        // sortedData1990[4].push("southwest")
                        for(let j=0; j<randomData.length; j++) {
                                if(randomData[j].region == "northeast") {
                                        //if(randomData[j].energySrc == "Coal" || randomData[j].energySrc =="Petroleum" || randomData[j].energySrc == "Natural Gas" || randomData[j].energySrc == "Solar Thermal and Photovoltaic" ) {
                                                sortedData1990[0].push({
                                                        year: 1990,
                                                        energySrc: randomData[j].energySrc,
