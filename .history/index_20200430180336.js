...
d3.csv(dataPath)
        .then(function (data) {
                ...
                for (let j = 0; j < 6; j++) { //For each Region
                        randomData[j] = []; //Have an Array For each region
                                ...
                                if (data[i].year == 1990) {
                                        if (data[i].energySrc == "Coal" || data[i].energySrc == "Petroleum" || data[i].energySrc == "Natural Gas" || data[i].energySrc == "Solar Thermal and Photovoltaic") {
                                                if (data[i].region == "west") {
                                                        randomData[j].push({ //Push averages for each energySrc x4
                                                                year: 1990,
                                                        ...
                                                        randomData[1].push({ //Push averages for each energySrc x4
                                                                year: 1990,
                                                                energySrc: data[i].energySrc,
                                                                region: data[i].region,
                                                                amount: data[i].amount
                                                        ...
                                                        randomData[2].push({ //Push averages for each energySrc x4
                                                                year: 1990,
                                                                energySrc: data[i].energySrc,
                                                                region: data[i].region,
                                                                amount: data[i].amount
                                                        ...
                                                        randomData[4].push({ //Push averages for each energySrc x4
                                                                year: 1990,
                                                                energySrc: data[i].energySrc,
                                                                region: data[i].region,
                                                                amount: data[i].amount
