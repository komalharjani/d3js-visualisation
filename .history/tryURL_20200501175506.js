...
d3.csv(dataPath)
    .then(function (data) {
        ...
        var xAxis = d3.axisBottom().scale(x0)
            .tickFormat("Region")
            .tickValues(keyValueArr.map(d => d.key));
    ...
    var categoriesNames = keyValueArr.map(function(d) { return d.key; });
    var rateNames       = keyValueArr[0].values.map(function(d) { return d.energy; });
