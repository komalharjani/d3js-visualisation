...
d3.csv(dataPath)
    .then(function (data) {
        ...
        var nestedData = d3.nest()
            ...
            .key(function (d) {
                if (d.energySrc == "Coal" || d.energySrc == "Nuclear" || d.energySrc == "Natural Gas" || d.energySrc == "Solar Thermal and Photovoltaic" || d.energySrc == "wind") {
                    return d.energySrc;
                }
            })
        ...
        slider.onchange = function () {
            ...
            //selectedYear data to be visualize
            ...
            x1.domain(energyNames).rangeRound([0, x0.bandwidth()]);
            ...
            function updateGraph() {
                ...
                slice.transition()
                    .duration(durations)
                    .attr("bX1", function (d, i) { return x0(d.currData) }) //ser 1 is current slider year
                    .attr("bX2", function (d, i) { return x1(d.currData) })
                    .attr("bY", function (d) { return y(d.currData) }) //ser 2 is the next year selected on slider
